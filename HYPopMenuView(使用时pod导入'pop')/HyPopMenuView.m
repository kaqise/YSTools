...
- (CGRect)getFrameAtIndex:(NSUInteger)index;
{
    ...
    if (_dataSource.count <= 3) {
        ...
        NSInteger num = _dataSource.count + 1;
        
        CGFloat button_W = MIN(CGRectGetWidth(self.frame), CGRectGetHeight(self.frame)) / num;
        
        CGFloat button_H = (button_W) - 10;
        
        CGFloat button_X = (self.bounds.size.width - button_W) / 2;
        
        CGFloat margin = (kH - (num * button_H)) / num;
        
        CGFloat button_Y = margin * (index + 1) + button_H * index;
        
        rect = CGRectMake(button_X, button_Y, button_W, button_H);
    }else{
        NSInteger column = 3;
        ...
        rect = CGRectMake(buttonViewX, buttonViewY, buttonViewWidth, buttonViewHeight);
    }
